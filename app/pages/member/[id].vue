...
// 新增：排名列表数据处理 (适配最新 NCSoft API 结构)
const rankingList = computed(() => {
  const list = member.value?.equipment_data?.raw_info?.ranking?.rankingList

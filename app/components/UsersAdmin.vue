...
const characterValidationRules = [
            ...
            const otherGroupSum = allCharacters
                .filter(
                    (char) =>
                        ...
                        char.id !== currentFormId,
                )
                .reduce(
                    (sum, char) => sum + (Number(char.storedDailyRuns) || 0),
                    0,
                );
    ...
    // 10. 特级会员剩余天数（前置条件：开启了特级会员 且 非同组共享）
    {
        ...
        validate: (form) => {
            ...
            const isSelfMember =
                form.premiumMember && !isGroupHasOtherPremium.value;
    ...
    // 古树庆典小游戏存储补充次数校验（组内共享上限 30）
    {
        ...
        validate: (form, context = {}) => {
            ...
            const otherGroupSum = allCharacters
                ...
                .reduce(
                    (sum, char) =>
                        sum + (Number(char.storedMinigameCount) || 0),
                    0,
                );

            // 同组总和 + 当前表单填写的值
            const total =
                otherGroupSum + (Number(form.storedMinigameCount) || 0);
...
const deleteGroup = async (id) => {
    ...
    if (hasCharsInGroup) {
        $alert(
            "该分组下仍有绑定的角色，无法直接删除！请先迁移或删除对应角色。",
        );
        return;
    }
...
const hasGroupMinigameCount = computed(() => {
    ...
    return allCharacters.some((char) => {
        ...
        return (
            isSameGroup && isNotSelf && (Number(char.minigameCount) || 0) > 0
        );
    });
});
    ...
    (newVal) => {
        ...
        if (newVal && Object.keys(newVal).length > 0) {
            ...
            if (totalGroupStoredMinigameCount.value > 30) {
                overrideForm.storedMinigameCount =
...
<template>
    ...
    >
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            >
                <div
                    class="text-slate-400 text-xs font-bold tracking-wider uppercase"
                >
                    总角色数
                </div>
                <div
                    class="text-3xl font-black mt-2 tracking-tight text-slate-900"
                >
                    {{ totalCharacters }}
                </div>
            </div>
            ...
            >
                ...
                <div
                    class="text-3xl font-black mt-2 text-emerald-600 tracking-tight"
                >
            ...
            >
                ...
                <div
                    class="text-3xl font-black mt-2 text-[#45a6d5] tracking-tight"
                >
            ...
            >
                ...
                <div
                    class="text-3xl font-black mt-2 text-amber-600 tracking-tight"
                >
                    {{ totalEnergy }}
                </div>
            </div>
        ...
        >
          {{
            ...
            >
                ...
                >
                    {{
                        gameData.characters.filter((c) => c.group === group.id)
                            .length
                    }}
                </span>
            </button>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div>
                                <div
                                    class="text-xl font-black tracking-wide text-slate-900"
                                >
                                    新增角色
                                </div>
                            </div>
                            ...
                            <template v-if="newCharForm.characterId">
                                    ...
                                    >
                                        ...
                                        >
                                            <div>
                                                ...
                                                <div
                                                    class="text-sm font-black text-slate-800 truncate"
                                                >
                                                    {{
                                                        newCharForm.characterName ||
                                                        newCharForm.name
                                                    }}
                                                    <span
                                                        class="text-xs font-bold text-[#45a6d5]"
                                                        >({{
                                                            newCharForm.className ||
                                                            newCharForm.class
                                                        }})</span
                                                    >
                                                </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="flex flex-col">
                                            <label
                                                class="text-xs font-bold text-slate-500 block mb-2"
                                                >主账号状态</label
                                            >
                                            <div
                                    ...
                                    <Transition name="fade">
                                        ...
                                        >
                                            ...
                                            >
                                                <label
                                                    class="text-xs font-bold text-amber-700 block"
                                                    >特级会员剩余天数</label
                                                >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="flex items-center gap-2">
                                            <span>奥德能量</span>
                                            <span
                                                class="text-xs font-black text-[#45a6d5]"
                                            >
                                                {{ newCharForm?.energy || 0 }}
                                                （+{{
                                                    newCharForm?.storedEnergy ||
                                                    0
                                                }}） /
                                                {{
                                                    newCharForm?.premiumMember ||
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                >
                                                <span
                                                    class="text-[10px] font-black text-[#45a6d5]"
                                                >
                                                    {{
                                                        newCharForm?.energy || 0
                                                    }}
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {{
                                                            newCharForm.storedNightmareCount ||
                                                            0
                                                        }}
                                                        / 30
                                                    </span>
                                            ...
                                            >
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        <input
                                                            v-model.number="
                                                                newCharForm.storedMinigameCount
                                                            "
                                                            type="number"
                                                            max="30"
                                                            min="0"
        ...
        <Teleport to="body">
            <Transition name="modal2">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <!-- 我的角色 -->
                            <div
                                v-if="pickerOpenOther.type == 'myroles'"
                                class="space-y-3"
                            >
                                <div class="flex items-center gap-2">
                                    <input
                    ...
                    >
                      删除
                            ...
                            <div
                                v-else-if="pickerOpenOther.type === 'add'"
                                class="space-y-3"
                            >
                                <div
                ...
                /> -->
                                ...
                                <div
                                    class="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-2"
                                >
                                    <input
                                        v-model="searchQuick"
